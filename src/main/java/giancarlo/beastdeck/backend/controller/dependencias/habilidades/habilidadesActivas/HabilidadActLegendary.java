...
public class HabilidadActLegendary implements HabilidadesInterfaz{

    public HabilidadActLegendary(int id, Carta cartaPropia, Combate combate, Carta cartaRival){
