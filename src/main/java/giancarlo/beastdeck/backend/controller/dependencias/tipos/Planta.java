 ...
 * @version 1.0.0
 */
public class Planta implements TiposInterfaz{
    ...
    public List<EnumTipos> debilidades() {
        List<EnumTipos> debilidadesPlanta = new ArrayList<>(Arrays.asList(EnumTipos.FUEGO, EnumTipos.ELECTRICO, EnumTipos.BESTIA));
        return debilidadesPlanta;
    }
